...
namespace SaleWebAspNet.Data
{
    ...
    {
        private SaleWebAspNetContext _context;

        public SeedingService(SaleWebAspNetContext context)
        {
            _context = context;
        }

        //Função para verificar se há uma base de dados em cada propriedade.
        public void Seed()
        {
            ...
            //Adicionando os objetos criados de cada classe em um range.
